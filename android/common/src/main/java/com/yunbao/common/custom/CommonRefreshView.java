...
public class CommonRefreshView extends FrameLayout implements View.OnClickListener {
    ...
    public CommonRefreshView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = ta.getColor(R.styleable.CommonRefreshView_crv_textColor, 0);
        ta.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        int textColor = mTextColor != 0 ? mTextColor : ContextCompat.getColor(mContext, R.color.textColor);
        if (mRefreshEnable) {
    ...
    private HttpCallback mRefreshCallback = new HttpCallback() {
        ...
        public void onFinish() {
            if (mSmartRefreshLayout != null) {
                mSmartRefreshLayout.finishRefresh(mLoadSuccess);
        ...
        public void onFinish() {
            if (mSmartRefreshLayout != null) {
                if (mDataCount < mItemCount) {
                    ...
                    mSmartRefreshLayout.finishLoadMore(mLoadSuccess);
                }
            }
        }
    };
