...
public class ChargeCoinAdapter extends RecyclerView.Adapter<ChargeCoinAdapter.Vh> {
    ...
    public ChargeCoinAdapter(Context context, List<CoinBean> list) {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(R.layout.item_coin2, parent, false));
    }
