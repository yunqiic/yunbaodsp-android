...
public class MainHomeHotViewHolder extends AbsVideoMainViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public MainHomeHotViewHolder(Context context, ViewGroup parentView) {
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(MainHomeHotViewHolder.this);
                }
                return mAdapter;
            }
    ...
    public void onVideoInsertListEvent(VideoInsertListEvent e) {
        if (Constants.VIDEO_HOME_HOT.equals(e.getKey()) && mAdapter != null) {
    ...
    public void onVideoScrollPageEvent(VideoScrollPageEvent e) {
        if (Constants.VIDEO_HOME_HOT.equals(e.getKey()) && mRefreshView != null) {
    ...
    public void onVideoDelete(VideoDeleteEvent e) {
        if (Constants.VIDEO_HOME_HOT.equals(e.getVideoKey()) && mAdapter != null) {
    ...
    public void onItemClick(VideoBean bean, final int position) {
        checkVideo(bean, new CommonCallback<Integer>() {
            ...
            public void callback(Integer bean) {
                ...
                VideoStorge.getInstance().putDataHelper(Constants.VIDEO_HOME_HOT, mVideoScrollDataHelper);
                VideoPlayActivity.forward(mContext, position, Constants.VIDEO_HOME_HOT, page, false);
            }
        });
    }
