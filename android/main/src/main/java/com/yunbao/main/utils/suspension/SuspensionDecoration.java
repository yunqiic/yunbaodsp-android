package com.yunbao.main.utils.suspension;
...
//    private LayoutInflater mInflater;
    ...
    public SuspensionDecoration(Context context) {
        super();
        COLOR_TITLE_BG = ContextCompat.getColor(context, R.color.black1);
        COLOR_TITLE_FONT = ContextCompat.getColor(context, R.color.gray3);
//        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
