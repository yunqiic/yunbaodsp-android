...
public class FansActivity extends AbsActivity implements OnItemClickListener<UserBean> {
    ...
    protected void main() {
        ...
        if (mToUid.equals(CommonAppConfig.getInstance().getUid())) {
            mRefreshView.setEmptyLayoutId(R.layout.view_empty_fans_1);
            setTitle(WordUtil.getString(R.string.fans_my_fans));
        } else {
            mRefreshView.setEmptyLayoutId(R.layout.view_empty_fans_0);
