...
public class UserLikeViewHolder extends AbsVideoMainViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public UserLikeViewHolder(Context context, ViewGroup parentView, String toUid) {
    ...
    @Override
    public void init() {
        mKey = Constants.VIDEO_USER_LIKE + this.hashCode();
        mRefreshView = (CommonRefreshView) findViewById(R.id.refreshView);
        if (!TextUtils.isEmpty(mToUid) && mToUid.equals(CommonAppConfig.getInstance().getUid())) {
            mRefreshView.setEmptyLayoutId(R.layout.view_empty_user_like_1);
        } else {
            mRefreshView.setEmptyLayoutId(R.layout.view_empty_user_like_2);
        }
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(UserLikeViewHolder.this);
                }
                return mAdapter;
            }
            ...
            public void loadData(int p, HttpCallback callback) {
                if (!TextUtils.isEmpty(mToUid)) {
                    MainHttpUtil.getUserLikeList(mToUid, p, callback);
                }
            }
        ...
        EventBus.getDefault().register(UserLikeViewHolder.this);
    }
